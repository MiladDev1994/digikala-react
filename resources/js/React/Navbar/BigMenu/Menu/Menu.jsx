                            ...
                            <div className={`${styles.menuFooter} bg-dark p-3`} style={{cursor:'default'}}>
                                {
                                    category.map(itemB => item.id === itemB.parent_id ?
                                        <div key={itemB.id} className={'float-start px-3 text-start mt-2'}>
                                            <Link to={`/${itemB.id}`} onClick={() => setMenu(false)} className={`border-start border-danger px-2  ${styles.menuItem}`} style={{fontWeight:'1000'}}>{itemB.name}</Link>
                                            {
                                                category.map(itemC => itemB.id === itemC.parent_id ?
                                                    <div key={itemC.id} className={'mt-2'}>
                                                        <Link to={`/${itemC.id}`} onClick={() => setMenu(false)} className={`px-2 ${styles.menuItem}`}>{itemC.name}</Link>
                                                        {
                                                            category.map(itemD => itemC.id === itemD.parent_id ?
                                                                <div key={itemD.id} className={'mt-2'}>
                                                                    <Link to={`/${itemD.id}`} onClick={() => setMenu(false)} className={`px-2 ${styles.menuItem}`}>{itemD.name}</Link>
                                                                    {
                                                                        category.map(itemE => itemD.id === itemE.parent_id ?
                                                                            <div key={itemE.id} className={'mt-2'}>
                                                                                <Link to={`/${itemE.id}`} onClick={() => setMenu(false)} className={`px-2 ${styles.menuItem}`}>{itemE.name}</Link>
                                                                                {
                                                                                    category.map(itemF => itemE.id === itemF.parent_id ?
                                                                                        <div key={itemF.id} className={'mt-2'}>
                                                                                            <Link to={`/${itemF.id}`} onClick={() => setMenu(false)} className={`px-2 ${styles.menuItem}`}>{itemF.name}</Link>
